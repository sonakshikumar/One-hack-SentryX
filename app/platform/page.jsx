...
const steps=[['01','RTSP streams','Your existing cameras deliver secure feeds to the local SkySentinel edge node.'],['02','YOLO server','Computer vision models identify people, vehicles, plates, and movement.'],['03','WebSocket events','Only meaningful, metadata-rich events move instantly through the network.'],['04','Mobile app','Teams receive a usable alert with context, location, and a video clip.']];

export default function Platform(){
  return (
    <div className="page">
      <section className="page-hero section">
        <p className="eyebrow">The SkySentinel platform</p>
